    ...
    public static void main(String[] args) {
        ...
        while (currentTime <= totalRunTime) {
            ...
            if (!(driver.getCurrentUrl().contains("financial-status-student-type"))) {
                ...
                driver.findElement(By.id("applicationRaisedDateDay")).sendKeys("01");
                driver.findElement(By.id("applicationRaisedDateMonth")).sendKeys("05");
                driver.findElement(By.id("applicationRaisedDateYear")).sendKeys("2016");
                driver.findElement(By.id("endDateDay")).sendKeys("20");
                driver.findElement(By.id("endDateMonth")).sendKeys("04");
